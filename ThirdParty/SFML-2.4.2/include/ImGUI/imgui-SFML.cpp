    ...
    const sf::Color& tintColor, const sf::Color& borderColor)
{
	...
	sf::FloatRect textureCoord = sf::FloatRect(uv0.x, uv0.y, uv1.x, uv1.y);
    ImGui::Image(texture, size, textureCoord, tintColor, borderColor);
}
    ...
    float thickness)
{
	...
	sf::Vector2f start = a + pos;
	sf::Vector2f end = b + pos;
	ImVec2 imStart = ImVec2(start.x, start.y);
	ImVec2 imEnd = ImVec2(end.x, end.y);
    draw_list->AddLine(imStart, imEnd, ColorConvertFloat4ToU32(imColor), thickness);
}
    ...
    float rounding, int rounding_corners, float thickness)
{
    ...
    draw_list->AddRect(
        ...
        ColorConvertFloat4ToU32(imColor), rounding, rounding_corners, thickness);
}
                     ...
                     const sf::Color& bgColor, const sf::Color& tintColor)
{
	...
	ImVec4 imTintColor = ImVec4(tintColor.r, tintColor.g, tintColor.b, tintColor.a);
	ImVec4 imBgColor = ImVec4(bgColor.r, bgColor.g, bgColor.b, bgColor.a);
